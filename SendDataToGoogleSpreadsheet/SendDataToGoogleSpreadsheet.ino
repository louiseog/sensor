...
const String CLIENT_ID = "632256606709-0auau4rn8o5ithhgrfivefs0hr7uj97k.apps.googleusercontent.com";

// the clientSecret found in Google's Developer Console under APIs & Auth > Credentials
const String CLIENT_SECRET = "bD0FaumA3oX8EhrAaF_vo2H5";

// returned after running FinalizeOAuth
const String REFRESH_TOKEN = "1/ayp-vl33sakvQXxBkfTKmtrnPSIkpMFNuFUv2CTzSrw";
...
// as described above.)
const String SPREADSHEET_TITLE = "1111YicBpfFgW7r10lDKLJR8g9jEPOW2bMF0DYKN0m3I";
